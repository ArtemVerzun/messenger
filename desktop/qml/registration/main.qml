    ...
    Container {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: "../resources/images/regpk.png"
            }
            ...
            Text {
                color: "#ffba00"
                text: "Мессенджер для компьютеров, с возможностью общения\n         с чат-ботом на основе искуственного интелекта"
                font.pointSize: 10
                anchors {
                    top: parent.top
                    topMargin: 500
