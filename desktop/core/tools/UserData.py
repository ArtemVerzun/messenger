...
class UserData:
    ...
    def save(cls, login=None, email=None, my_id=None, password=None, first_name=None, last_name=None):
        if email != '' and email:
            cls.__set_my_email(email)
        if my_id != '' and my_id:
            cls.__set_my_id(my_id)
        if login != '' and login:
            cls.__set_my_login(login)
        if password != '' and password:
            cls.__set_password(password)
        if first_name != '' and first_name:
            cls.__set_first_name(first_name)
        if last_name != '' and last_name:
            cls.__set_last_name(last_name)
